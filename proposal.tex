...
\begin{figure} [t]
    \centering
    \vspace{0cm}
    \makebox[\textwidth][c]{\includegraphics[width=1.0\textwidth]{architecture.pdf}}
...
\section{Approach} 
\thispagestyle{empty} % Remove pages numbering 

\begin{figure} [t]
    \centering
    \vspace{-2cm}
    \makebox[\textwidth][c]{\includegraphics[width=1.0\textwidth]{workflow.pdf}}
...
\begin{figure} [t]
    \centering
    \vspace{0cm}
    \makebox[\textwidth][c]{\includesvg[inkscapelatex=false, width=1.0\textwidth]{PoS_example.svg}}
...
\begin{figure} [t]
    ...
    %\vspace{-2cm}
    %\hspace{-1.3cm}
    \makebox[\textwidth][c]{\includegraphics[width=1.0\textwidth]{schedule.pdf}}
